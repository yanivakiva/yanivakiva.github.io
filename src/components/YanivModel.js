    ...
    (function () {
      ...
      function init() {
        ...
        loader.load(
          ...
          function (gltf) {
            ...
            fileAnimations[0].tracks.splice(3, 3);
            fileAnimations[0].tracks.splice(9, 3);
            idle = mixer.clipAction(fileAnimations[0]);
            idle.play();
          },
        ...
        // Floor
        let floorGeometry = new THREE.PlaneGeometry(100, 30, 1, 1);
        ...
        let geometry = new THREE.SphereGeometry(20, 50, 55);
      ...
      function getMouseDegrees(x, y, degreeLimit) {
        ...
        if (x >= w.x / 4) {
          xdiff = x - w.x / 4;
          xPercentage = (xdiff / (w.x / 4)) * 100;
          dx = (degreeLimit * xPercentage) / 300;
        }
